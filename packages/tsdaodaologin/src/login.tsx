        ...
        return <Provider create={() => {
            ...
            return <div className="wk-login">
                <div className="wk-login-content">
                    <div className="wk-login-content-phonelogin" style={{ "display": vm.loginType === LoginType.phone_login ? "block" : "none" }}>
                        ...
                        <div className="wk-login-content-form">
                            ...
                            <div className="wk-login-content-form-buttons">
                                <Button className="wk-login-content-form-ok" type='secondary' theme='solid' onClick={() => {
                                    vm.loginType = LoginType.phone_register
                                }}>注册</Button>
                            </div>
...
{/*                     
                    <div className={classNames("wk-login-content-scanlogin", vm.loginType === LoginType.qrcode_login ? "wk-login-content-scanlogin-show" : undefined)}>
                        ...
                        <div className="wk-login-footer-buttons">
                            <button onClick={() => {
                                vm.loginType = LoginType.phone_login
                            }}>使用手机号登录</button>
                        </div>

                    </div> */}

                    <div className="wk-login-content-phonelogin" style={{ "display": vm.loginType === LoginType.phone_register ? "block" : "none" }}>
                        <div className="wk-login-content-logo">
                            <img src={`${process.env.PUBLIC_URL}/logo.png`} alt="logo" />
                        </div>
                        <div className="wk-login-content-slogan">
                        ...
                        <div className="wk-login-content-form">
                            ...
                            <div className="wk-login-content-form-buttons">
                                <Button loading={vm.registerLoading} className="wk-login-content-form-ok" type='primary' theme='solid' onClick={async () => {
                                    ...
                                    vm.requestRegisterWithUsernameAndPwd(fullPhone, vm.password).catch((err) => {
                                        Toast.error(err.msg)
                                    })
                                }}>注册</Button>
                            </div>
                    ...
                    <div className="wk-login-footer">
                        ...
                        <div className="version">v{WKApp.config.appVersion}</div>
                    </div>
                </div>
